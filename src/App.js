...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      <Navbar/>
        <Routes>
          <Route path="/" element={<News  key="sport" pageSize={this.pageSize} country="in" category="sport"/>}/> 
          ...
          <Route path="/sport" element={<News  key="sport" pageSize={this.pageSize} country="in" category="sport"/>} /> 
